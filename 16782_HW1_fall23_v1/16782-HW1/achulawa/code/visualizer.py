...
if __name__ == "__main__":
    ...
    # ani.save(f"C:/Users/amanc/OneDrive/Desktop/Fall_2023/16782/Planning-in-Robotics/16782_HW1_fall23_v1/16782-HW1/{sys.argv[1]}.gif", dpi=300, writer=PillowWriter(fps=100))
    plt.legend()
    plt.show()